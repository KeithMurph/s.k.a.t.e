...
sleep(1)
print(f"Welcome {Fore.GREEN + name}" + Fore.YELLOW )
sleep(1.2)
print(Fore.CYAN + "The rules are simple")
sleep(1.2)
print(Fore.CYAN + "Match enough tricks to wear out the PC")
sleep(1.2)
print(Fore.CYAN + "Miss the trick you get a letter 'S' ")
sleep(1.2)
print(Fore.CYAN + "Reach S.K.A.T.E. you lose")
sleep(1)
